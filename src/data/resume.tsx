  ...
  projects: [
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/oogunjob/CleanType",
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/oogunjob/wallpaperz",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/oogunjob/3D-Carousel",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/oogunjob/Buddy-Finder",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/oogunjob/Coffee-Website",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "",
    ...
    },
    {
      ...
      active: true,
      description:
        "It was my final year [Project](https://github.com/oogunjob/ResumeBuilder) in our college, It is a interactive and versatile Dynamic CV Builder, completely build from scratch with backend functionallity .",
      technologies: [
        "CSS",
        "javascript",
        "MongoDB",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/oogunjob/ResumeBuilder",
          icon: <Icons.github className="size-3" />,
        },
      ],
