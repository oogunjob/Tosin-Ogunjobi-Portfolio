...
export default function Navbar() {
  return (
    <div className="fixed inset-x-0 top-0 z-30 mx-auto mt-4 flex origin-top h-full max-h-14">
      ...
      <div className="fixed top-0 inset-x-0 h-16 w-full pointer-events-none bg-gradient-to-b from-background/40 via-background/25 to-transparent backdrop-blur-xl [-webkit-mask-image:linear-gradient(to_bottom,black,transparent)] dark:from-black/30 dark:via-black/20"></div>
